...
{ 
  ...
  pinMode(9,OUTPUT);                         //LED input 
}

void loop(void)
{
  digitalWrite(9, HIGH);                      //always switch on the LED for the photometer
  int sensorValue = analogRead(A0);           //input for the photodiode
  // print out the value you read:

  //CODE FOR THE pHmeter
  ...
  {
        Serial.print(sensorValue);                            //print value of the photodiode 
        Serial.print(";");                                    //print voltage on the serial monitor
        Serial.print(voltage,2);                              //print voltage to two decimal places
        Serial.print(";");                                    //print pH value on the serial monitor
